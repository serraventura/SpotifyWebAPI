describe('Music Explorer Controller:  ', function () {
    ...
    beforeEach(angular.mock.inject(function ($rootScope, statusService, Settings, service, $controller) {
    ...
    it('On Load Page list of albums: Rooster Illusion ', function () {
        expect( scope.allAlbumsList[0].name ).to.equal('Rooster Illusion');
    });
